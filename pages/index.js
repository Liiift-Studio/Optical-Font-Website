                        ...
                        <Grid container item  display={{xs:'none', sm:'flex'}} xs={2} sm={6} md={1} justifyContent="flex-end" alignItems="center">
                            {( lightSwitch ) ? (
                                <IconButton aria-labelledby='mode' p={0} m={0} onClick={changeDarkMode}>
                                    ...
                                    :
                                        <SvgIcon id='mode'sx={{fontSize:'3rem'}} viewBox="-5 -5 55 55" alt='Dark mode icon button to switch to dark mode with higher contrast colours'>
                                            <path fillRule="evenodd" clip-rule="evenodd" d="M30.3255 1.31292C25.5842 3.53751 22.3008 8.35436 22.3008 13.9381C22.3008 21.6359 28.5411 27.8762 36.2389 27.8762C39.7114 27.8762 42.8873 26.6063 45.3275 24.5057C44.4069 36.1975 34.6275 45.3984 22.6992 45.3984C10.1628 45.3984 0 35.2356 0 22.6992C0 10.1628 10.1628 0 22.6992 0C25.3746 0 27.942 0.462877 30.3255 1.31292Z"/>
                                        </SvgIcon>
                                    )}
                                </IconButton>
                            ) : (<></>)}
