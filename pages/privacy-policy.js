                ...
                {/* </section> */}
                    <Grid item container sx={copy}>
                        <Typography variant='body1' display ="block">
                          <p>
                          By using or accessing the Service, regardless of how accessed, you signify your agreement to be legally bound by this Privacy Policy (the “Policy”). If you do not agree to the Policy, you should not access or otherwise use the Service, as defined below. The Policy applies to all visitors and others who access or use the Service (“users”).                            <br/><br/>
                          </p>
                          <p>
                    ...
                    <Box id="Data" ref={dataRef} tabIndex={0} sx={focusStyle}>
                          ...
                          <p>
                          3. PURPOSES FOR COLLECTION AND USE OF YOUR INFORMATION
                          </p>
                          <p>
                          To respond to your questions and concerns;
To correct technical problems and malfunctions related to the Service. 
                          </p>
                          <p>
                          4. HOW YOUR INFORMATION IS DISCLOSED OR SHARED
                          </p>
                          <p>
                          We may engage third-party external servers as well as other external services, including cloud services and cloud compatible servers. These services may independently collect information.
                          </p>
                          <p>
...
We employ reasonable physical, electronic and procedural safeguards that are designed to protect personal information under our control against unauthorized access and use.
                          ...
                          <p>
                          6. KEEPING INFORMATION ACCURATE / ACCESS AND CORRECTION
                          </p>
                          <p>
                          ...
                          <p>
                          Optical, Liiift Studio
                          </p>
                          <p>
                          520 E 1st Ave, Vancouver, BC, V5T 1E1, Canada
E-mail: tyler@access-font.com
                          </p>
                          <p>
