                    ...
                    <Grid item container md={8} alignItems="top">
                        <Grid item container sx={copy_container} >
                            ...
                            <Box id="BrowserExtWeb" ref={browserExtWebRef} sx={focusStyle} tabIndex={0} mt="2rem">
                                ...
                                <Grid item container sx={copy}>
                                    <Typography variant='body1' display="block">
                                        <p>On the web and extension side of the project, I initially imagined a 20 questions approach: presented with two variations of a letter, choose the version which works better for you, repeat to verify, rule out less useful letter shapes, repeat and hone in on the most useful legibility characteristics. The website evaluation would do most of the customization and the extension would simply deliver the end result. We moved away from this approach for several reasons. Diving deeper into research, I read Beier’s PhD. She showed that subjective first impressions are very often a poor indicator of legibility. The web-based customization tool relied too heavily on subjective first impressions. It’d be complicated and time-consuming to return to and continuously refine settings. A UX researcher on our web development team at Liiift studio offered great advice here as well. I did speak to an eye doctor who suggested there may be a way to make a more complex legibility assessment work well, and I still think there is the possibility to do so, but for our purposes, we changed gears.</p>
                                        <p>The approach we landed on was significantly less guided. It relies on people’s knowledge and self-assessment of their own needs and continuous refinement. Simple slider bars tailor the font family. Settings are saved in the extension and can be returned to and adjusted. Instead of a complex evaluation, we follow the lead of much of the rest of the assistive software community in which user adjustment and customization is expected. We did test an intermediate version of the project with some guidance, but it didn’t test well. There is strong precedent for full user control. In 2004, Aries Arditi, a psychologist with a Ph.D. and a postdoc from NYU, created a font customization system with support from the U.S. National Institutes of Health. His tool used slider bars to control various legibility characteristics of letters for people with low vision. He tested it with 40 people, many with maculopathy, cataracts, or glaucoma and vision between 20/60 and 20/200 acuity. People created a huge range of letter styles. His main finding was that people with varied vision benefited from varied letters. Arditi wasn’t able to show that his letters were more legible than established fonts, possibly because they were really quite unconventional in construction, too unfamiliar. He referred to his software as spartan, didn’t release it to the public, and suggested that font designers may be able to create a more extensive version. </p>
                                        ...
                                        <p>One last note on web and extension design: feedback early on in the project from a few people with low vision highlighted the importance of strong dark modes. Light bleed in light mode can be overbearing and so we spent some time dialing this in.</p>
                                         </Typography>
                                </Grid>
                            </Box>
                            ...
                            <Box id='NextSteps' ref={nextStepstRef} sx={focusStyle} tabIndex={0} mt="2rem">
                                ...
                                <Grid item container sx={copy}>
                                    <Typography variant='body1' display="block">
                                        ...
                                        {/* <section id='Contact' ref={contactRef}> */}
                                        <p>Optical is not done. The problem is not solved. Vision, accessibility, type and the internet are all independently complex things that continue to evolve. The diversity of experiences of low vision and the sheer complexity of devices and tools in this space mean It won’t work perfectly for everyone, every website, in every situation. There are more than a few ways to continue making this thing better.</p>
                                        <p>One finding from research and feedback was the benefit of a career in software for some with low vision. By one estimate, people with vision loss are employed and educated at half the rate of the general population. The prevalence of work-from-home in the software industry means people don’t have to commute, they can use computers set up with their own suite of assistive tools, and can control room lighting. We’d like to expand Optical to work for coding. This means a monospace version of the font family, and customization tools that work for a code editor or terminal.</p>
                                        <p>Currently Optical works in the Chrome browser on desktop. Optical adjusts the typography of the websites you visit, in a sense doing a minor redesign of the internet. That’s not a small task, and could be refined. Additionally, most people don’t interact with the written word through desktop computers. We’d like to make Optical work offline, on other devices and in other software.</p>
                                        ...
                                        <p>Finally, Optical includes some accents and diacritics for Latin-based languages. The site and extension are available only in English. Improved language support is something needed in all design, Optical included. The most common letters and letter pairs in different languages play an interesting role in familiarity and therefore legibility and so deserve attention.</p>
                                        <p>As this phase of development comes to an end, we’re looking for partners to collaborate to continue pushing the project. Please reach out if you’re interested.</p>
                                        {/* </section> */}
                                    </Typography>
                                </Grid>
                            </Box>
