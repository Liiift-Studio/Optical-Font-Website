                ...
                <Box id="Intro" ref={introRef} tabIndex={0} sx={focusStyle}>
                    ...
                    <Box id="Foundations" ref={foundationsRef} tabIndex={0} sx={focusStyle} mt="2rem">
                      ...
                      <Grid item container sx={copy}>
                          ...
                          <p>
                          I use the term ‘low vision’ to describe a broad range of vision below 20/40 acuity from a variety of sources including refractive errors, cataracts, glaucoma, diabetic retinopathy and others. Others use ‘low vision’ to describe more advanced symptoms closer to legal blindness. Low vision impacts various parts of the visual field. Currently, people with low vision use a variety of tools to improve font legibility. The most effective is magnification. Magnification is great, but it can disrupt the flow of text. Fonts like FS Me, Inclusive Sans, and Atkinson Hyperlegible all offer valuable approaches to legibility for low vision. Other fonts not designed specifically for low vision offer useful approaches as well (Work Sans). Lexend provides strong customization for new readers.                           
                          </p>
                          <p>
                          Many type design techniques that improve legibility for a general audience appear to be valuable to those with low vision. Balance between positive and negative space provides clarity. Open shapes help prevent letters from blurring in on each other. Optical therefore uses open apertures. Wide spacing helps minimize the effect of crowding, letters blurring out their neighbours. Subtle differentiations like a tail on a lowercase l, or a two story lowercase a construction appear help minimize confusion between similar letter shapes.                           
                          </p>
                          <p>
                          Improving legibility for low vision requires balancing the need for familiarity with clarifying and sometimes exagerating letters’ essential identifying characteristics.
                          </p>
                          <p>
                          Work from Mackebben, Beier, and others has shown benefit to increasing the differentiation between commonly misidentified letters:  I, l, 1, i, and !, O and 0 for example.  Work from .... has highlights the utility of increasing letter spacing. 
                          </p>
                          <p>
                          Spend time on concepts, ideas, research
                          </p>
                          </Typography>
                        </Grid>
                      </Box>
                      ...
                      <Grid item container sx={copy}>
                          ...
                          <p>
                          Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Optical Font. 
                          </p>
                          <p>
...
Third-party Social Media Service means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service. 
                          ...
                          <p>
                          Website refers to Optical Font, accessible from https://opticalfont.com/
                          </p>
                          <p>
